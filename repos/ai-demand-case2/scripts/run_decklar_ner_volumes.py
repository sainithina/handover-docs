#!/usr/bin/env python3
"""
NER + noun-phrase chunking with importance_score >= 0.1 threshold for Decklar prompts.

Reads prompts from decklar-prompts-20260728.xlsx (sheet "Prompt – Performing Prompts"),
...
fetches SV/ASV via DataForSEO, fuses with Case2Estimator, and writes results to Excel.

Usage:
    PYTHONPATH=src python scripts/run_decklar_ner_volumes.py
"""
...
INPUT_PATH = Path("/Users/sainithinartham/Downloads/decklar-prompts-20260728.xlsx")
INPUT_SHEET = "Prompt – Performing Prompts"
OUTPUT_DIR = REPO_ROOT / "runs" / "decklar_ner_th0.1"
OUTPUT_PATH = OUTPUT_DIR / "decklar-prompts-20260728-ner-volumes.xlsx"
OUTPUT_PATH_DOWNLOADS = Path("/Users/sainithinartham/Downloads/decklar-prompts-20260728-ner-volumes.xlsx")
